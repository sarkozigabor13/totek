...
const SingleBrand = ({ brand }: { brand: Brand }) => {
  const { image, href, name, imageLight, id, grayscale } = brand;
  ...
  return (
    <>
      <motion.a
        ...
        viewport={{ once: true }}
        href={href}
        className={`animate_top mx-w-full relative block h-30 contrast-0 ${grayscale && "grayscale-100 contrast-100"}`}
        target="_blank"
      >
        <Image

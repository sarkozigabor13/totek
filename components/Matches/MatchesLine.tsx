          ...
          >
            ...
            >
              <div className="grid grid-cols-2 gap-x-3 border-b px-8 py-4 last:border-b-0">
                <div className="group/item flex items-center justify-between even:flex-row-reverse">
                  <div className="flex items-center gap-1.5 group-even/item:flex-row-reverse">
                    ...
                    <div className="text-custom-gray-900 min-w-0 text-sm/tight font-bold dark:text-white">
                  ...
                  <div className="text-custom-gray-900 relative inline-flex items-center gap-x-2 text-sm/tight font-bold group-first/item:after:absolute group-first/item:after:start-full group-first/item:after:top-0 group-first/item:after:translate-x-1/2 group-first/item:after:content-['-'] dark:text-white">

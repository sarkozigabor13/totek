                ...
                <div className="group/item items-top flex justify-between even:flex-row-reverse">
                  <div className="flex flex-col">
                    <div className="items-top flex gap-1.5 group-even/item:flex-row-reverse">
                      ...
                      <div className="text-custom-gray-900 min-w-0 text-md font-bold dark:text-white">
                  ...
                  <div className="text-custom-gray-900 items-top relative inline-flex gap-x-2 text-md font-bold group-first/item:after:absolute group-first/item:after:start-full group-first/item:after:top-0 group-first/item:after:translate-x-1/2 group-first/item:after:content-['-'] dark:text-white">

    ...
    <div className="mx-auto w-full">
      <div className="bg-blacksection rounded-2xl px-4 py-7 shadow-2xl md:px-8">
        {matches?.map((match, ix) => {
          const isPlayed = match.result; // vagy: new Date(match.date) <= new Date()
          return (
            <motion.div
              key={ix}
              variants={{
            ...
            >
              <div
                className={`ring-custom-gray-200 mt-0.5 rounded-t-3xl bg-black ring-1 ${
                  isPlayed
                    ? match.wld === "win"
                      ? "ring-win"
                      : match.wld === "lose"
              ...
              >
                <h4 className="px-4 py-4 text-center text-xl font-bold text-white md:px-8">
                  {match?.location}
                  <br />
                ...
                <div
                  className={`bg-blacksection relative mb-10 rounded-t-3xl after:absolute after:-bottom-[1px] after:h-px after:w-full ${
                    isPlayed
                      ? match.wld === "win"
                        ? "after-win"
                        : match.wld === "lose"
                ...
                >
                  {/* Ha lejátszott, mutatjuk a teljes tartalmat */}
                  {isPlayed ? (
                    <div>
                      <div className="grid grid-cols-2 gap-x-3 px-4 py-4 last:border-b-0 md:px-8">
                        <div className="group/item items-top flex justify-between even:flex-row-reverse">
                          <div className="flex flex-col">
                            <div className="items-top flex gap-1.5 group-even/item:flex-row-reverse">
                              ...
                              <div className="text-custom-gray-900 min-w-0 text-xl font-bold dark:text-white">
                            ...
                            {match.goals?.length > 0 && (
                              <div className="mt-3 text-sm text-gray-200">
                                <div className="list-inside list-disc text-lg">
                          ...
                          <div className="text-custom-gray-900 items-top relative inline-flex gap-x-2 text-lg font-bold group-first/item:after:absolute group-first/item:after:start-full group-first/item:after:top-0 group-first/item:after:translate-x-1/2 group-first/item:after:content-['-'] dark:text-white">
                        ...
                        <div className="group/item items-top flex justify-between even:flex-row-reverse">
                          <div className="items-top flex gap-1.5 group-even/item:flex-row-reverse">
                            ...
                            <div className="text-custom-gray-900 min-w-0 text-lg font-bold dark:text-white">
                              <div className="hidden max-w-[120px] truncate sm:inline-block">
                                {match.opponent}
                              </div>
                              <div className="inline-block sm:hidden">
                    ...
                    /* Ha még nem játszották, csak összecsukva: csapatok neve és logó */
                    <div className="grid grid-cols-3 items-center gap-4 px-4 py-4 md:px-8">
                      {/* Mi csapatunk */}
      ...
      <div className="px-4 py-4 text-center text-gray-400">
              Még nem lejátszott
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {/* Ha van logó, ide lehet tenni pl: `/images/logo/${abbreviateTeamName(match.opponent)}.svg` */}
                        <svg
                          viewBox="0 0 420 420"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
